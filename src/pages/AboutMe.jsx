  ...
  return (
    <div id="generic-bg">
      ...
      <section class="pt-80" id="main-section">
        <div class="flex justify-around items-center mx-64 text-white">
      ...
      <section class="pb-80 flex justify-around items-center mx-64 text-white">
        <img
          src="./src/assets/images/placeholder.jpg"
          alt="foto francesca"
          class="w-96 mr-20"
        ...
        <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200" data-aos-once="true">
          ...
          <div class="text-2xl flex">
            Memorie di luce significa questo e quest'altro...
